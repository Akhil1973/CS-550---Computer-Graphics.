    ...
    for (int ilat = 0; ilat < NumLats; ilat++)
    {
        ...
        for (int ilng = 0; ilng < NumLngs; ilng++)
        {
            ...
            else
            {
                ...
                p->s = (lng + cosf(2 * M_PI * (Time + (float)ilng / (float)NumLngs))) / (2. * M_PI);
...
Display()
{
    ...
    if (TexOn == OFF) {
        ...
        if (ImgOn == ONE) {
            ...
            Textures =
                BmpToTexture("D:/Computer Graphics/SampleWindows/SampleFreeGlut2019/night_world.bmp", &ear_width, &ear_height);
            ...
            Textures =
                BmpToTexture("D:/Computer Graphics/SampleWindows/SampleFreeGlut2019/worldtex.bmp", &ear_width, &ear_height);
            glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
            glGenTextures(1, &tex0); // assign binding “handles”
            glBindTexture(GL_TEXTURE_2D, tex0);
    ...
    glLoadIdentity();
    glColor3f(1., 1., 1.);
    DoRasterString(5., 5., 0., "Akhil Sai Chintala 934409906");
